...
const HourlyOne = props => (
    <div className="Hourly">
        ...
        {  props.hourlist  && props.hourlist.length >1 && <div className="col-xs-2 hour"> 
            { props.hourlist && props.hourlist.length > 1 && <p>Time:&nbsp;{props.hourlist[1].time}</p> }
            { props.hourlist[1] && <p>Temparature:&nbsp; {props.hourlist[1].temp} </p>}
            { props.hourlist[1] && <p>Humidity:&nbsp; {props.hourlist[1].humidity} </p>}
        </div> }

        { props.hourlist && props.hourlist.length > 2 && <div className="col-xs-2 hour">
        ...
        { props.hourlist && props.hourlist.length > 3 && <div className="col-xs-2 hour">
        ...
        { props.hourlist && props.hourlist.length > 4 && <div className="col-xs-2 hour">
        ...
        { props.hourlist && props.hourlist.length > 5 && <div className="col-xs-2 hour">
        ...
        { props.hourlist && props.hourlist.length > 6  && <div className="col-xs-2 hour">
        ...
        { props.hourlist && props.hourlist.length > 7  && <div className="col-xs-2 hour">
